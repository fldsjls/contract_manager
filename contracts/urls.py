...
urlpatterns = [
    ...
    path("contracts/import/invoice-template/", views.invoice_import_template, name="invoice_import_template"),
    path("contracts/import/record-template/", views.record_import_template, name="record_import_template"),
    path("contracts/<int:pk>/records-export/", views.contract_records_export, name="contract_records_export"),
    path("contracts/new/", views.contract_create, name="contract_create"),
    path("contracts/<int:pk>/snapshots/export/", views.contract_snapshot_export, name="contract_snapshot_export"),
    ...
    path("records/<str:kind>/<int:pk>/preview/", views.record_file_preview, name="record_file_preview"),
